    ...
    <footer className="bg-gray-900 text-white border-t-4 border-yellow-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/location" className="text-gray-400 hover:text-yellow-500 transition">Location</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Radheshyam Royal. All rights reserved. | MAHARERA Approved</p>
        </div>
      </div>
    </footer>
  );
